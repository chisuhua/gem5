...
scons -j6 --with-cxx-config --without-python --without-tcmalloc build/X86_VI_hammer/libgem5_debug.so --verbose BUILD_PPU=yes USE_ZEPHYR=yes --default=../design/gpgpu/build_opts/X86_VI_hammer EXTRAS=design/gpgpu
