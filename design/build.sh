...
scons -j$GEM5_CPU_CORES $GEM5_ROOT/build/X86_VI_hammer/gem5.$GEM5_VARIANT --without-tcmalloc --verbose --default=$GEM5_ROOT/design/gpgpu/build_opts/X86_VI_hammer EXTRAS=design/gpgpu
