...
#if !defined(__GEM5OPUUMD_RUNTIME_API_H__)
#define __GEM5OPUUMD_RUNTIME_API_H__

/**
 * \file
 * \name gem5umd Runtime API
 * \author NVIDIA Corporation
 */

/**
 * \defgroup gem5umdRT gem5umd Runtime API
 *
 ...
 *
 * The \ref gem5umdRT_HIGHLEVEL "C++ API" (<i>cuda_runtime.h</i>) is a
 ...
 * compiler. The C++ API also has some gem5umd-specific wrappers that wrap
...
/** gem5umd Runtime API Version 3.2 */
// #define gem5umdRT_VERSION  3020
#define gem5umdRT_VERSION  10000
...
extern  void  gem5umdRegisterFunction(void *fatCubinHandle, const char *hostFun, const char *deviceFun );
extern  cudaError_t  gem5umdRegisterPtxInfo(const char *, gpgpu_ptx_sim_info);
extern  cudaError_t  gem5umdRegisterFatBinary(symbol_table *symtab, unsigned int handle);

/**
 * \defgroup gem5umdRT_THREAD Thread Management
 * This section describes the thread management functions of the gem5umd runtime
...
/**
 * \brief Exit and clean up from gem5umd launches
 *
 ...
 */
extern  cudaError_t  gem5umdThreadExit(void);
 ...
 * \sa ::cudaThreadExit
 */
extern  cudaError_t  gem5umdThreadSynchronize(void);
 ...
 */
extern  cudaError_t  gem5umdThreadSetLimit(enum cudaLimit limit, size_t value);
 ...
 */
// extern  cudaError_t  gem5umdThreadGetLimit(size_t *pValue, enum cudaLimit limit);
 ...
 * \notefnerr
 *
 * \sa gem5umdThreadSetCacheConfig,
 * \ref ::cudaFuncSetCacheConfig(const char*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C API)",
 * \ref ::cudaFuncSetCacheConfig(T*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C++ API)"
 */
extern  cudaError_t  gem5umdThreadGetCacheConfig(enum cudaFuncCache *pCacheConfig);
 ...
 * \ref ::cudaFuncSetCacheConfig(T*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C++ API)"
 */
extern  cudaError_t  gem5umdThreadSetCacheConfig(enum cudaFuncCache cacheConfig);

/** @} */ /* END gem5umdRT_THREAD */

/**
 * \defgroup gem5umdRT_ERROR Error Handling
 * This section describes the error handling functions of the gem5umd runtime
 * application programming interface.
 *
 * @{
 */
 ...
 */
extern  cudaError_t  gem5umdGetLastError(void);
 ...
 */
extern  cudaError_t  gem5umdPeekAtLastError(void);
 ...
 */
extern  const char*  gem5umdGetErrorString(cudaError_t error);
/** @} */ /* END gem5umdRT_ERROR */

/**
 * \defgroup gem5umdRT_DEVICE Device Management
 * This section describes the device management functions of the gem5umd runtime
 * application programming interface.
 *
 * @{
 */
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5umdGetDeviceCount(int *count);
 ...
 *   device can map host memory into the gem5umd address space for use with
 ...
 *   - gem5umdComputeModeDefault: Default mode - Device is not restricted and
 *     multiple threads can use ::cudaSetDevice() with this device.
 *   - gem5umdComputeModeExclusive: Compute-exclusive mode - Only one thread will
 *     be able to use ::cudaSetDevice() with this device.
 *   - gem5umdComputeModeProhibited: Compute-prohibited mode - No threads can use
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5umdGetDeviceProperties(struct cudaDeviceProp *prop, int device);
 ...
 */
extern  cudaError_t  gem5umdChooseDevice(int *device, const struct cudaDeviceProp *prop);
 ...
 * device code.
 * If the host thread has already initialized the gem5umd runtime by
 * calling non-device management runtime functions or if there exists a gem5umd
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5umdSetDevice(int device);
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5umdGetDevice(int *device);

/**
 * \brief Set a list of devices that can be used for gem5umd
 *
 * Sets a list of devices for gem5umd execution in priority order using
 * \p device_arr. The parameter \p len specifies the number of elements in the
 * list. gem5umd will try devices from the list sequentially until it finds one
 * that works. If this function is not called, or if it is called with a \p len
 * of 0, then gem5umd will go back to its default behavior of trying devices
 * sequentially from a default list containing all of the available gem5umd
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5umdSetValidDevices(int *device_arr, int len);
 ...
 * zero, uses a heuristic based on the number of active gem5umd contexts in the
 * process \p C and the number of logical processors in the system \p P. If
 * \p C \> \p P, then gem5umd will yield to other OS threads when waiting for the
 * device, otherwise gem5umd will not yield while waiting for results and
 * actively spin on the processor.
 * - ::cudaDeviceScheduleSpin: Instruct gem5umd to actively spin when waiting for
 ...
 * work in parallel with the gem5umd thread.
 * - ::cudaDeviceScheduleYield: Instruct gem5umd to yield its thread when waiting
 ...
 * - ::cudaDeviceBlockingSync: Instruct gem5umd to block the CPU thread on a
 ...
 * - ::cudaDeviceLmemResizeToMax: Instruct gem5umd to not reduce local memory
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5umdSetDeviceFlags( unsigned int flags );

/** @} */ /* END gem5umdRT_DEVICE */

/**
 * \defgroup gem5umdRT_STREAM Stream Management
 * This section describes the stream management functions of the gem5umd runtime
 * application programming interface.
 *
 * @{
 */
 ...
 */
extern  cudaError_t  gem5umdStreamCreate(cudaStream_t *pStream);
 ...
 */
extern  cudaError_t  gem5umdStreamDestroy(cudaStream_t stream);
 ...
 */
extern  cudaError_t  gem5umdStreamWaitEvent(cudaStream_t stream, cudaEvent_t event, unsigned int flags);
 ...
 */
extern  cudaError_t  gem5umdStreamSynchronize(cudaStream_t stream);
 ...
 */
extern  cudaError_t  gem5umdStreamQuery(cudaStream_t stream);

/** @} */ /* END gem5umdRT_STREAM */

/**
 * \defgroup gem5umdRT_EVENT Event Management
 * This section describes the event management functions of the gem5umd runtime
 * application programming interface.
 *
 * @{
 */
 ...
 * ::cudaStreamWaitEvent
 */
extern  cudaError_t  gem5umdEventCreate(cudaEvent_t *event);
 ...
 * ::cudaStreamWaitEvent
 */
extern  cudaError_t  gem5umdEventCreateWithFlags(cudaEvent_t *event, unsigned int flags);
 ...
 * recorded after all preceding operations in the gem5umd context have been
 ...
 * ::cudaStreamWaitEvent
 */
extern  cudaError_t  gem5umdEventRecord(cudaEvent_t event, cudaStream_t stream __dv(0));
 ...
 * ::cudaEventSynchronize, ::cudaEventDestroy, ::cudaEventElapsedTime
 */
extern  cudaError_t  gem5umdEventQuery(cudaEvent_t event);
 ...
 */
extern  cudaError_t  gem5umdEventSynchronize(cudaEvent_t event);
 ...
 */
extern  cudaError_t  gem5umdEventDestroy(cudaEvent_t event);
 ...
 */
extern  cudaError_t  gem5umdEventElapsedTime(float *ms, cudaEvent_t start, cudaEvent_t end);

/** @} */ /* END gem5umdRT_EVENT */

/**
 * \defgroup gem5umdRT_EXECUTION Execution Control
 * This section describes the execution control functions of the gem5umd runtime
 * application programming interface.
 *
 * @{
 */
 ...
 * \sa
 * \ref ::cudaFuncSetCacheConfig(const char*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C API)",
 * \ref ::cudaFuncGetAttributes(struct gem5umdFuncAttributes*, const char*) "cudaFuncGetAttributes (C API)",
 * \ref ::cudaLaunch(const char*) "cudaLaunch (C API)",
 * ::cudaSetDoubleForDevice,
 * ::cudaSetDoubleForHost,
 * \ref ::cudaSetupArgument(const void*, size_t, size_t) "cudaSetupArgument (C API)",
 */
extern  cudaError_t  gem5umdConfigureCall(dim3 gridDim, dim3 blockDim, size_t sharedMem __dv(0), cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5umdSetupArgument(const void *arg, size_t size, size_t offset);
// extern  cudaError_t  gem5umdSetupArgument(function_info* f, const void **args);
 ...
 */
extern  cudaError_t  gem5umdFuncSetCacheConfig(const char *func, enum cudaFuncCache cacheConfig);
 ...
 * \sa ::cudaConfigureCall,
 * \ref ::cudaFuncSetCacheConfig(const char*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C API)",
 * \ref ::cudaFuncGetAttributes(struct gem5umdFuncAttributes*, T*) "cudaFuncGetAttributes (C++ API)",
 * \ref ::cudaLaunch(const char*) "cudaLaunch (C API)",
 * ::cudaSetDoubleForDevice,
 * ::cudaSetDoubleForHost,
 * \ref ::cudaSetupArgument(const void*, size_t, size_t) "cudaSetupArgument (C API)"
 */
extern  cudaError_t  gem5umdFuncGetAttributes(struct gem5umdFuncAttributes *attr, const char *func);
 ...
 * \ref ::cudaSetupArgument(const void*, size_t, size_t) "cudaSetupArgument (C API)"
 */
extern  cudaError_t  gem5umdSetDoubleForDevice(double *d);
 ...
 * \ref ::cudaSetupArgument(const void*, size_t, size_t) "cudaSetupArgument (C API)"
 */
extern  cudaError_t  gem5umdSetDoubleForHost(double *d);

/** @} */ /* END gem5umdRT_EXECUTION */

/**
 * \defgroup gem5umdRT_MEMORY Memory Management
 * This section describes the memory management functions of the gem5umd runtime
 * application programming interface.
 *
 * @{
 */
 ...
 */
extern  cudaError_t  gem5umdMalloc(void **devPtr, size_t size);
 ...
 * ::cudaFreeHost, ::cudaHostAlloc
 */
extern  cudaError_t  gem5umdMallocHost(void **ptr, size_t size);
 ...
 * of device memory (whether linear memory or gem5umd arrays).
 *
 ...
 * ::cudaHostAlloc
 */
extern  cudaError_t  gem5umdMallocPitch(void **devPtr, size_t *pitch, size_t width, size_t height);

/**
 * \brief Allocate an array on the device
 *
 * Allocates a gem5umd array according to the ::cudaChannelFormatDesc structure
 * \p desc and returns a handle to the new gem5umd array in \p *array.
 *
 ...
 * ::cudaHostAlloc
 */
extern  cudaError_t  gem5umdMallocArray(struct libcuda::cudaArray **array, const struct cudaChannelFormatDesc *desc, size_t width, size_t height __dv(0), unsigned int flags __dv(0));
 ...
 * ::cudaHostAlloc
 */
extern  cudaError_t  gem5umdFree(void *devPtr);
 ...
 */
extern  cudaError_t  gem5umdFreeHost(void *ptr);

/**
 * \brief Frees an array on the device
 *
 * Frees the gem5umd array \p array, which must have been * returned by a
 ...
 * ::cudaFreeHost, ::cudaHostAlloc
 */
// TODO extern  cudaError_t  gem5umdFreeArray(struct cudaArray *array);
 ...
 * considered as pinned memory by all gem5umd contexts, not just the one that
 * performed the allocation.
 * - ::cudaHostAllocMapped: Maps the allocation into the gem5umd address space.
 ...
 *
 * The ::cudaHostAllocMapped flag may be specified on gem5umd contexts for devices
 * that do not support mapped pinned memory. The failure is deferred to
 * ::cudaHostGetDevicePointer() because the memory may be mapped into other
 * gem5umd contexts via the ::cudaHostAllocPortable flag.
 *
 ...
 * ::cudaFreeHost
 */
extern  cudaError_t  gem5umdHostAlloc(void **pHost, size_t size, unsigned int flags);
 ...
 */
extern  cudaError_t  gem5umdHostGetDevicePointer(void **pDevice, void *pHost, unsigned int flags);
 ...
 * \sa ::cudaHostAlloc
 */
extern  cudaError_t  gem5umdHostGetFlags(unsigned int *pFlags, void *pHost);
 ...
 * involving 2D or 3D objects (whether linear memory or gem5umd arrays).
 *
 ...
 */
extern  cudaError_t  gem5umdMalloc3D(struct cudaPitchedPtr* pitchedDevPtr, struct cudaExtent extent);
 ...
 * ::make_cudaExtent
 */
// TODO extern  cudaError_t  gem5umdMalloc3DArray(struct cudaArray** array, const struct cudaChannelFormatDesc* desc, struct cudaExtent extent, unsigned int flags __dv(0));
...
struct gem5umdPos make_cudaPos(size_t x, size_t y, size_t z);

struct gem5umdMemcpy3DParms {
  struct cudaArray     *srcArray;
  struct gem5umdPos        srcPos;
  struct cudaPitchedPtr srcPtr;
  struct cudaArray     *dstArray;
  struct gem5umdPos        dstPos;
 ...
 * destination objects may be in either host memory, device memory, or a gem5umd
 ...
 * For gem5umd arrays, positions must be in the range [0, 2048) for any
 * dimension.
 *
 * The \p extent field defines the dimensions of the transferred area in
 * elements. If a gem5umd array is participating in the copy, the extent is
 * defined in terms of that array's elements. If no gem5umd array is
 ...
 */
extern  cudaError_t  gem5umdMemcpy3D(const struct gem5umdMemcpy3DParms *p);
 ...
 * ::make_cudaExtent, ::make_cudaPos
 */
extern  cudaError_t  gem5umdMemcpy3DAsync(const struct gem5umdMemcpy3DParms *p, cudaStream_t stream __dv(0));
 ...
 *
 */
extern  cudaError_t  gem5umdMemGetInfo(size_t *free, size_t *total);
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5umdMemcpy(void *dst, const void *src, size_t count, enum cudaMemcpyKind kind);

/**
 * \brief Copies data between host and device
 *
 * Copies \p count bytes from the memory area pointed to by \p src to the
 * gem5umd array \p dst starting at the upper left corner
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpyToArray(struct cudaArray *dst, size_t wOffset, size_t hOffset, const void *src, size_t count, enum cudaMemcpyKind kind);

/**
 * \brief Copies data between host and device
 *
 * Copies \p count bytes from the gem5umd array \p src starting at the upper
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpyFromArray(void *dst, const struct cudaArray *src, size_t wOffset, size_t hOffset, size_t count, enum cudaMemcpyKind kind);

/**
 * \brief Copies data between host and device
 *
 * Copies \p count bytes from the gem5umd array \p src starting at the upper
 * left corner (\p wOffsetSrc, \p hOffsetSrc) to the gem5umd array \p dst
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpyArrayToArray(struct cudaArray *dst, size_t wOffsetDst, size_t hOffsetDst, const struct cudaArray *src, size_t wOffsetSrc, size_t hOffsetSrc, size_t count, enum cudaMemcpyKind kind __dv(cudaMemcpyDeviceToDevice));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5umdMemcpy2D(void *dst, size_t dpitch, const void *src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind);

/**
 * \brief Copies data between host and device
 *
 * Copies a matrix (\p height rows of \p width bytes each) from the memory
 * area pointed to by \p src to the gem5umd array \p dst starting at the
 ...
 * \p width must not exceed the width of the gem5umd array \p dst. \p width must
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpy2DToArray(struct cudaArray *dst, size_t wOffset, size_t hOffset, const void *src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind);

/**
 * \brief Copies data between host and device
 *
 * Copies a matrix (\p height rows of \p width bytes each) from the gem5umd
 ...
 * row. \p wOffset + \p width must not exceed the width of the gem5umd array
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpy2DFromArray(void *dst, size_t dpitch, const struct cudaArray *src, size_t wOffset, size_t hOffset, size_t width, size_t height, enum cudaMemcpyKind kind);
 ...
 * Copies a matrix (\p height rows of \p width bytes each) from the gem5umd
 * array \p srcArray starting at the upper left corner
 * (\p wOffsetSrc, \p hOffsetSrc) to the gem5umd array \p dst starting at
 ...
 * of the gem5umd array \p dst. \p wOffsetSrc + \p width must not exceed the width
 * of the gem5umd array \p src.
 *
 * \param dst        - Destination memory address
 * \param wOffsetDst - Destination starting X offset
 * \param hOffsetDst - Destination starting Y offset
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpy2DArrayToArray(struct cudaArray *dst, size_t wOffsetDst, size_t hOffsetDst, const struct cudaArray *src, size_t wOffsetSrc, size_t hOffsetSrc, size_t width, size_t height, enum cudaMemcpyKind kind __dv(cudaMemcpyDeviceToDevice));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5umdMemcpyToSymbol(const char *symbol, const void *src, size_t count, size_t offset __dv(0), enum cudaMemcpyKind kind __dv(cudaMemcpyHostToDevice));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5umdMemcpyFromSymbol(void *dst, const char *symbol, size_t count, size_t offset __dv(0), enum cudaMemcpyKind kind __dv(cudaMemcpyDeviceToHost));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5umdMemcpyAsync(void *dst, const void *src, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpyToArrayAsync(struct cudaArray *dst, size_t wOffset, size_t hOffset, const void *src, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpyFromArrayAsync(void *dst, const struct cudaArray *src, size_t wOffset, size_t hOffset, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5umdMemcpy2DAsync(void *dst, size_t dpitch, const void *src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpy2DToArrayAsync(struct cudaArray *dst, size_t wOffset, size_t hOffset, const void *src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
// TODO extern  cudaError_t  gem5umdMemcpy2DFromArrayAsync(void *dst, size_t dpitch, const struct cudaArray *src, size_t wOffset, size_t hOffset, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5umdMemcpyToSymbolAsync(const char *symbol, const void *src, size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5umdMemcpyFromSymbolAsync(void *dst, const char *symbol, size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5umdMemset(void *devPtr, int value, size_t count, cudaStream_t stream __dv(0));
 ...
 * ::cudaMemset2DAsync, ::cudaMemset3DAsync
 */
extern  cudaError_t  gem5umdMemset2D(void *devPtr, size_t pitch, int value, size_t width, size_t height);
 ...
 * ::make_cudaExtent
 */
extern  cudaError_t  gem5umdMemset3D(struct cudaPitchedPtr pitchedDevPtr, int value, struct cudaExtent extent);
 ...
 * ::cudaMemset2DAsync, ::cudaMemset3DAsync
 */
extern  cudaError_t  gem5umdMemsetAsync(void *devPtr, int value, size_t count, cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5umdMemset2DAsync(void *devPtr, size_t pitch, int value, size_t width, size_t height, cudaStream_t stream __dv(0));
 ...
 * ::make_cudaExtent
 */
extern  cudaError_t  gem5umdMemset3DAsync(struct cudaPitchedPtr pitchedDevPtr, int value, struct cudaExtent extent, cudaStream_t stream __dv(0));

/**
 * \brief Finds the address associated with a gem5umd symbol
 *
 ...
 */
extern  cudaError_t  gem5umdGetSymbolAddress(void **devPtr, const char *symbol);

/**
 * \brief Finds the size of the object associated with a gem5umd symbol
 *
 ...
 */
extern  cudaError_t  gem5umdGetSymbolSize(size_t *size, const char *symbol);

/** @} */ /* END gem5umdRT_MEMORY */

/** \defgroup gem5umdRT_OPENGL OpenGL Interoperability */

/** \defgroup gem5umdRT_D3D9 Direct3D 9 Interoperability */

/** \defgroup gem5umdRT_D3D10 Direct3D 10 Interoperability */

/** \defgroup gem5umdRT_D3D11 Direct3D 11 Interoperability */

/** \defgroup gem5umdRT_VDPAU VDPAU Interoperability */

/**
 * \defgroup gem5umdRT_INTEROP Graphics Interoperability
 * This section describes the graphics interoperability functions of the gem5umd
...
/**
 * \brief Unregisters a graphics resource for access by gem5umd
 *
 * Unregisters the graphics resource \p resource so it is not accessible by
 * gem5umd unless registered again.
 *
 ...
 */
extern  cudaError_t  gem5umdGraphicsUnregisterResource(cudaGraphicsResource_t resource);
 ...
 *     be used. It is therefore assumed that gem5umd may read from or write to \p resource.
 * - ::cudaGraphicsMapFlagsReadOnly: Specifies that gem5umd will not write to \p resource.
 * - ::cudaGraphicsMapFlagsWriteDiscard: Specifies gem5umd will not read from \p resource and will
 *   write over the entire contents of \p resource, so none of the data
 *   previously stored in \p resource will be preserved.
 *
 * If \p resource is presently mapped for access by gem5umd then ::cudaErrorUnknown is returned.
 ...
 */
extern  cudaError_t  gem5umdGraphicsResourceSetMapFlags(cudaGraphicsResource_t resource, unsigned int flags);

/**
 * \brief Map graphics resources for access by gem5umd
 *
 * Maps the \p count graphics resources in \p resources for access by gem5umd.
 *
 * The resources in \p resources may be accessed by gem5umd until they
 * are unmapped. The graphics API from which \p resources were registered
 * should not access any resources while they are mapped by gem5umd. If an
 * application does so, the results are undefined.
 *
 * This function provides the synchronization guarantee that any graphics calls
 * issued before ::cudaGraphicsMapResources() will complete before any subsequent gem5umd
 ...
 * gem5umd then ::cudaErrorUnknown is returned.
 *
 * \param count     - Number of resources to map
 * \param resources - Resources to map for gem5umd
 ...
 */
extern  cudaError_t  gem5umdGraphicsMapResources(int count, cudaGraphicsResource_t *resources, cudaStream_t stream __dv(0));
 ...
 *
 * Once unmapped, the resources in \p resources may not be accessed by gem5umd
 * until they are mapped again.
 *
 * This function provides the synchronization guarantee that any gem5umd work issued
 ...
 * ::cudaGraphicsMapResources
 */
extern  cudaError_t  gem5umdGraphicsUnmapResources(int count, cudaGraphicsResource_t *resources, cudaStream_t stream __dv(0));
 ...
 * ::cudaGraphicsSubResourceGetMappedArray
 */
extern  cudaError_t  gem5umdGraphicsResourceGetMappedPointer(void **devPtr, size_t *size, cudaGraphicsResource_t resource);
 ...
 */
// TODO extern  cudaError_t  gem5umdGraphicsSubResourceGetMappedArray(struct cudaArray **array, cudaGraphicsResource_t resource, unsigned int arrayIndex, unsigned int mipLevel);

/** @} */ /* END gem5umdRT_INTEROP */

/**
 * \defgroup gem5umdRT_TEXTURE Texture Reference Management
 * This section describes the low level texture reference management functions
 * of the gem5umd runtime application programming interface.
 *
 * @{
 */
 ...
 *
 * Returns in \p *desc the channel descriptor of the gem5umd array \p array.
 *
 ...
 * \notefnerr
 *
 * \sa \ref ::cudaCreateChannelDesc(int, int, int, int, gem5umdChannelFormatKind) "cudaCreateChannelDesc (C API)",
 ...
 */
// TODO extern  cudaError_t  gem5umdGetChannelDesc(struct cudaChannelFormatDesc *desc, const struct cudaArray *array);
 ...
 * \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
 */
extern  struct cudaChannelFormatDesc  gem5umdCreateChannelDesc(int x, int y, int z, int w, enum cudaChannelFormatKind f);
 ...
 * \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
 */
extern  cudaError_t  gem5umdBindTexture(size_t *offset, const struct textureReference *texref, const void *devPtr, const struct cudaChannelFormatDesc *desc, size_t size __dv(UINT_MAX));
 ...
 * \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
 */
extern  cudaError_t  gem5umdBindTexture2D(size_t *offset, const struct textureReference *texref, const void *devPtr, const struct cudaChannelFormatDesc *desc, size_t width, size_t height, size_t pitch);

/**
 * \brief Binds an array to a texture
 *
 * Binds the gem5umd array \p array to the texture reference \p texref.
 * \p desc describes how the memory is interpreted when fetching values from
 * the texture. Any gem5umd array previously bound to \p texref is unbound.
 *
 * \param texref - Texture to bind
 * \param array  - Memory array on device
 * \param desc   - Channel format
 ...
 * \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
 */
// TODO extern  cudaError_t  gem5umdBindTextureToArray(const struct textureReference *texref, const struct cudaArray *array, const struct cudaChannelFormatDesc *desc);
 ...
 * \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
 */
extern  cudaError_t  gem5umdUnbindTexture(const struct textureReference *texref);
 ...
 */
extern  cudaError_t  gem5umdGetTextureAlignmentOffset(size_t *offset, const struct textureReference *texref);
 ...
 * \ref ::cudaUnbindTexture(const struct textureReference*) "cudaUnbindTexture (C API)"
 */
extern  cudaError_t  gem5umdGetTextureReference(const struct textureReference **texref, const char *symbol);

/** @} */ /* END gem5umdRT_TEXTURE */

/**
 * \defgroup gem5umdRT_SURFACE Surface Reference Management
 ...
 *
 * Binds the gem5umd array \p array to the surface reference \p surfref.
 * \p desc describes how the memory is interpreted when fetching values from
 * the surface. Any gem5umd array previously bound to \p surfref is unbound.
 *
 ...
 */
// TODO extern  cudaError_t  gem5umdBindSurfaceToArray(const struct surfaceReference *surfref, const struct cudaArray *array, const struct cudaChannelFormatDesc *desc);
 ...
 */
extern  cudaError_t  gem5umdGetSurfaceReference(const struct surfaceReference **surfref, const char *symbol);

/** @} */ /* END gem5umdRT_SURFACE */

/**
 * \defgroup gem5umdRT__VERSION Version Management
 *
 * @{
 */

/**
 * \brief Returns the gem5umd driver version
 *
 * Returns in \p *driverVersion the version number of the installed gem5umd
 ...
 *
 * \param driverVersion - Returns the gem5umd driver version.
 *
 * \return
 * ::cudaSuccess,
 * ::cudaErrorInvalidValue
 ...
 */
extern  cudaError_t  gem5umdDriverGetVersion(int *driverVersion);

/**
 * \brief Returns the gem5umd Runtime version
 *
 * Returns in \p *runtimeVersion the version number of the installed gem5umd
 * Runtime. This function automatically returns ::cudaErrorInvalidValue if
 * the \p runtimeVersion argument is NULL.
 *
 * \param runtimeVersion - Returns the gem5umd Runtime version.
 *
 * \return
 * ::cudaSuccess,
 * ::cudaErrorInvalidValue
 ...
 */
extern  cudaError_t  gem5umdRuntimeGetVersion(int *runtimeVersion);

/** @} */ /* END gem5umdRT__VERSION */

/** \cond impl_private */
extern  cudaError_t  gem5umdGetExportTable(const void **ppExportTable, const cudaUUID_t *pExportTableId);
/** \endcond impl_private */

/**
 * \defgroup gem5umdRT_HIGHLEVEL C++ API Routines
 * This section describes the C++ high level API functions of the gem5umd runtime
 * application programming interface. To use these functions, your
 * application needs to be compiled with the \p nvcc compiler.
 *
 * \brief C++-style interface built on top of gem5umd runtime API
 */

/**
 * \defgroup gem5umdRT_DRIVER Interactions with the gem5umd Driver API
 * This section describes the interactions between the gem5umd Driver API and the gem5umd Runtime API
 *
 * \brief Interactions between the gem5umd Driver API and the gem5umd Runtime API.
 *
 * @{
 *
 * \section gem5umdRT_CUDA_context Context Management
 *
 * gem5umd Runtime API calls operate on the gem5umd Driver API ::CUcontext which is bound to the current host thread.
 *
 * If there exists no gem5umd Driver API ::CUcontext bound to the current thread at the time of a gem5umd
 * Runtime API call which requires a ::CUcontext then the gem5umd Runtime will implicitly create a new
 * ::CUcontext before executing the call.
 *
 * If the gem5umd Runtime creates a ::CUcontext then the ::CUcontext will be created using the parameters
 * specified by the gem5umd Runtime API functions
 * ::cudaSetDevice,
 * ::cudaSetValidDevices,
 * ::cudaSetDeviceFlags,
 * ::cudaGLSetGLDevice,
 ...
 *
 * If a ::CUcontext is created by the gem5umd Runtime, then the gem5umd runtime will decrement the
 * reference count of that ::CUcontext in the function ::cudaThreadExit.
 * If a ::CUcontext is created by the gem5umd Driver API (or is created by a separate instance of the
 * gem5umd Runtime API library), then the gem5umd Runtime will not increment or decrement the reference
 * count of that ::CUcontext.
 *
 * All gem5umd Runtime API state (e.g, global variables' addresses and values) travels
 * with its underlying ::CUcontext.
 * In particular, if a ::CUcontext is moved from one thread to another (using ::cuCtxPopCurrent and
 * ::cuCtxPushCurrent) then all gem5umd Runtime API state will move to that thread as well.
 *
 * Please note that attaching to legacy contexts (those with a version of 3010 as returned
 * by ::cuCtxGetApiVersion()) is not possible. The gem5umd Runtime will return
 * ::cudaErrorIncompatibleDriverContext in such cases.
 *
 * \section gem5umdRT_CUDA_stream Interactions between CUstream and cudaStream_t
 *
 * The types ::CUstream and ::cudaStream_t are identical and may be used interchangeably.
 *
 * \section gem5umdRT_CUDA_event Interactions between CUevent and cudaEvent_t
 *
 * The types ::CUevent and ::cudaEvent_t are identical and may be used interchangeably.
 *
 * \section gem5umdRT_CUDA_array Interactions between CUarray and struct cudaArray *
 *
 ...
 *
 * In order to use a ::CUarray in a gem5umd Runtime API function which takes a struct ::cudaArray *,
 * it is necessary to explicitly cast the ::CUarray to a struct ::cudaArray *.
 *
 * In order to use a struct ::cudaArray * in a gem5umd Driver API function which takes a ::CUarray,
 * it is necessary to explicitly cast the struct ::cudaArray * to a ::CUarray .
 *
 * \section gem5umdRT_CUDA_graphicsResource Interactions between CUgraphicsResource and cudaGraphicsResource_t
 *
 * The types ::CUgraphicsResource and struct ::cudaGraphicsResource * represent the same data type and may be used
 * interchangeably by casting the two types between each other.
 *
 * In order to use a ::CUgraphicsResource in a gem5umd Runtime API function which takes a struct ::cudaGraphicsResource *,
 * it is necessary to explicitly cast the ::CUgraphicsResource to a struct ::cudaGraphicsResource *.
 *
 * In order to use a struct ::cudaGraphicsResource * in a gem5umd Driver API function which takes a ::CUgraphicsResource,
 * it is necessary to explicitly cast the struct ::cudaGraphicsResource * to a ::CUgraphicsResource .
 *
 * @}
 */

// extern  cudaError_t  gem5umdDeviceGetAttribute(int *value, enum cudaDeviceAttr attr, int device);
#if defined(__cplusplus)
}
#endif /* __cplusplus */
...
#endif /* !__GEM5OPUUMD_RUNTIME_API_H__ */
