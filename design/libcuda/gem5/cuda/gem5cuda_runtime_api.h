...
#if !defined(__GEM5CUDA_RUNTIME_API_H__)
#define __GEM5CUDA_RUNTIME_API_H__

/**
 * \file
 * \name gem5cuda Runtime API
 * \author NVIDIA Corporation
 */

/**
 * \defgroup gem5cudaRT gem5cuda Runtime API
 *
 ...
 *
 * The \ref gem5cudaRT_HIGHLEVEL "C++ API" (<i>cuda_runtime.h</i>) is a
 ...
 * compiler. The C++ API also has some gem5cuda-specific wrappers that wrap
...
/** gem5cuda Runtime API Version 3.2 */
// #define gem5cudaRT_VERSION  3020
#define gem5cudaRT_VERSION  10000
 ...
 * This section describes the thread management functions of the gem5cuda runtime
...
/**
 * \brief Exit and clean up from gem5cuda launches
 *
 ...
 */
extern  cudaError_t  gem5cudaThreadExit(void);
 ...
 * \sa ::cudaThreadExit
 */
extern  cudaError_t  gem5cudaThreadSynchronize(void);
 ...
 */
extern  cudaError_t  gem5cudaThreadSetLimit(enum cudaLimit limit, size_t value);
 ...
 */
// extern  cudaError_t  gem5cudaThreadGetLimit(size_t *pValue, enum cudaLimit limit);
 ...
 * \notefnerr
 *
 * \sa gem5cudaThreadSetCacheConfig,
 * \ref ::cudaFuncSetCacheConfig(const char*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C API)",
 * \ref ::cudaFuncSetCacheConfig(T*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C++ API)"
 */
extern  cudaError_t  gem5cudaThreadGetCacheConfig(enum cudaFuncCache *pCacheConfig);
 ...
 * \ref ::cudaFuncSetCacheConfig(T*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C++ API)"
 */
extern  cudaError_t  gem5cudaThreadSetCacheConfig(enum cudaFuncCache cacheConfig);

/** @} */ /* END gem5cudaRT_THREAD */

/**
 * \defgroup gem5cudaRT_ERROR Error Handling
 * This section describes the error handling functions of the gem5cuda runtime
 * application programming interface.
 *
 * @{
 */
 ...
 */
extern  cudaError_t  gem5cudaGetLastError(void);
 ...
 */
extern  cudaError_t  gem5cudaPeekAtLastError(void);
 ...
 */
extern  const char*  gem5cudaGetErrorString(cudaError_t error);
/** @} */ /* END gem5cudaRT_ERROR */

/**
 * \defgroup gem5cudaRT_DEVICE Device Management
 * This section describes the device management functions of the gem5cuda runtime
 * application programming interface.
 *
 * @{
 */
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5cudaGetDeviceCount(int *count);
 ...
 *   device can map host memory into the gem5cuda address space for use with
 ...
 *   - gem5cudaComputeModeDefault: Default mode - Device is not restricted and
 *     multiple threads can use ::cudaSetDevice() with this device.
 *   - gem5cudaComputeModeExclusive: Compute-exclusive mode - Only one thread will
 *     be able to use ::cudaSetDevice() with this device.
 *   - gem5cudaComputeModeProhibited: Compute-prohibited mode - No threads can use
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5cudaGetDeviceProperties(struct cudaDeviceProp *prop, int device);
 ...
 */
extern  cudaError_t  gem5cudaChooseDevice(int *device, const struct cudaDeviceProp *prop);
 ...
 * device code.
 * If the host thread has already initialized the gem5cuda runtime by
 * calling non-device management runtime functions or if there exists a gem5cuda
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5cudaSetDevice(int device);
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5cudaGetDevice(int *device);

/**
 * \brief Set a list of devices that can be used for gem5cuda
 *
 * Sets a list of devices for gem5cuda execution in priority order using
 * \p device_arr. The parameter \p len specifies the number of elements in the
 * list. gem5cuda will try devices from the list sequentially until it finds one
 * that works. If this function is not called, or if it is called with a \p len
 * of 0, then gem5cuda will go back to its default behavior of trying devices
 * sequentially from a default list containing all of the available gem5cuda
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5cudaSetValidDevices(int *device_arr, int len);
 ...
 * zero, uses a heuristic based on the number of active gem5cuda contexts in the
 * process \p C and the number of logical processors in the system \p P. If
 * \p C \> \p P, then gem5cuda will yield to other OS threads when waiting for the
 * device, otherwise gem5cuda will not yield while waiting for results and
 * actively spin on the processor.
 * - ::cudaDeviceScheduleSpin: Instruct gem5cuda to actively spin when waiting for
 ...
 * work in parallel with the gem5cuda thread.
 * - ::cudaDeviceScheduleYield: Instruct gem5cuda to yield its thread when waiting
 ...
 * - ::cudaDeviceBlockingSync: Instruct gem5cuda to block the CPU thread on a
 ...
 * - ::cudaDeviceLmemResizeToMax: Instruct gem5cuda to not reduce local memory
 ...
 * ::cudaChooseDevice
 */
extern  cudaError_t  gem5cudaSetDeviceFlags( unsigned int flags );

/** @} */ /* END gem5cudaRT_DEVICE */

/**
 * \defgroup gem5cudaRT_STREAM Stream Management
 * This section describes the stream management functions of the gem5cuda runtime
 * application programming interface.
 *
 * @{
 */
 ...
 */
extern  cudaError_t  gem5cudaStreamCreate(cudaStream_t *pStream);
 ...
 */
extern  cudaError_t  gem5cudaStreamDestroy(cudaStream_t stream);
 ...
 */
extern  cudaError_t  gem5cudaStreamWaitEvent(cudaStream_t stream, cudaEvent_t event, unsigned int flags);
 ...
 */
extern  cudaError_t  gem5cudaStreamSynchronize(cudaStream_t stream);
 ...
 */
extern  cudaError_t  gem5cudaStreamQuery(cudaStream_t stream);

/** @} */ /* END gem5cudaRT_STREAM */

/**
 * \defgroup gem5cudaRT_EVENT Event Management
 * This section describes the event management functions of the gem5cuda runtime
 * application programming interface.
 *
 * @{
 */
 ...
 * ::cudaStreamWaitEvent
 */
extern  cudaError_t  gem5cudaEventCreate(cudaEvent_t *event);
 ...
 * ::cudaStreamWaitEvent
 */
extern  cudaError_t  gem5cudaEventCreateWithFlags(cudaEvent_t *event, unsigned int flags);
 ...
 * recorded after all preceding operations in the gem5cuda context have been
 ...
 * ::cudaStreamWaitEvent
 */
extern  cudaError_t  gem5cudaEventRecord(cudaEvent_t event, cudaStream_t stream __dv(0));
 ...
 * ::cudaEventSynchronize, ::cudaEventDestroy, ::cudaEventElapsedTime
 */
extern  cudaError_t  gem5cudaEventQuery(cudaEvent_t event);
 ...
 */
extern  cudaError_t  gem5cudaEventSynchronize(cudaEvent_t event);
 ...
 */
extern  cudaError_t  gem5cudaEventDestroy(cudaEvent_t event);
 ...
 */
extern  cudaError_t  gem5cudaEventElapsedTime(float *ms, cudaEvent_t start, cudaEvent_t end);

/** @} */ /* END gem5cudaRT_EVENT */

/**
 * \defgroup gem5cudaRT_EXECUTION Execution Control
 * This section describes the execution control functions of the gem5cuda runtime
 * application programming interface.
 *
 * @{
 */
 ...
 * \sa
 * \ref ::cudaFuncSetCacheConfig(const char*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C API)",
 * \ref ::cudaFuncGetAttributes(struct gem5cudaFuncAttributes*, const char*) "cudaFuncGetAttributes (C API)",
 * \ref ::cudaLaunch(const char*) "cudaLaunch (C API)",
 * ::cudaSetDoubleForDevice,
 * ::cudaSetDoubleForHost,
 * \ref ::cudaSetupArgument(const void*, size_t, size_t) "cudaSetupArgument (C API)",
 */
extern  cudaError_t  gem5cudaConfigureCall(dim3 gridDim, dim3 blockDim, size_t sharedMem __dv(0), cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5cudaFuncSetCacheConfig(const char *func, enum cudaFuncCache cacheConfig);
 ...
 * \sa ::cudaConfigureCall,
 * \ref ::cudaFuncSetCacheConfig(const char*, enum cudaFuncCache) "cudaFuncSetCacheConfig (C API)",
 * \ref ::cudaFuncGetAttributes(struct gem5cudaFuncAttributes*, T*) "cudaFuncGetAttributes (C++ API)",
 * \ref ::cudaLaunch(const char*) "cudaLaunch (C API)",
 * ::cudaSetDoubleForDevice,
 * ::cudaSetDoubleForHost,
 * \ref ::cudaSetupArgument(const void*, size_t, size_t) "cudaSetupArgument (C API)"
 */
extern  cudaError_t  gem5cudaFuncGetAttributes(struct gem5cudaFuncAttributes *attr, const char *func);
 ...
 * \ref ::cudaSetupArgument(const void*, size_t, size_t) "cudaSetupArgument (C API)"
 */
extern  cudaError_t  gem5cudaSetDoubleForDevice(double *d);
 ...
 * \ref ::cudaSetupArgument(const void*, size_t, size_t) "cudaSetupArgument (C API)"
 */
extern  cudaError_t  gem5cudaSetDoubleForHost(double *d);

/** @} */ /* END gem5cudaRT_EXECUTION */

/**
 * \defgroup gem5cudaRT_MEMORY Memory Management
 * This section describes the memory management functions of the gem5cuda runtime
 * application programming interface.
 *
 * @{
 */
 ...
 */
extern  cudaError_t  gem5cudaMalloc(void **devPtr, size_t size);
 ...
 * ::cudaFreeHost, ::cudaHostAlloc
 */
extern  cudaError_t  gem5cudaMallocHost(void **ptr, size_t size);
 ...
 * of device memory (whether linear memory or gem5cuda arrays).
 *
 ...
 * ::cudaHostAlloc
 */
extern  cudaError_t  gem5cudaMallocPitch(void **devPtr, size_t *pitch, size_t width, size_t height);

/**
 * \brief Allocate an array on the device
 *
 * Allocates a gem5cuda array according to the ::cudaChannelFormatDesc structure
 * \p desc and returns a handle to the new gem5cuda array in \p *array.
 *
 ...
 * ::cudaHostAlloc
 */
extern  cudaError_t  gem5cudaFree(void *devPtr);
 ...
 */
extern  cudaError_t  gem5cudaFreeHost(void *ptr);

/**
 * \brief Frees an array on the device
 *
 * Frees the gem5cuda array \p array, which must have been * returned by a
 ...
 * considered as pinned memory by all gem5cuda contexts, not just the one that
 * performed the allocation.
 * - ::cudaHostAllocMapped: Maps the allocation into the gem5cuda address space.
 ...
 *
 * The ::cudaHostAllocMapped flag may be specified on gem5cuda contexts for devices
 * that do not support mapped pinned memory. The failure is deferred to
 * ::cudaHostGetDevicePointer() because the memory may be mapped into other
 * gem5cuda contexts via the ::cudaHostAllocPortable flag.
 *
 ...
 * ::cudaFreeHost
 */
extern  cudaError_t  gem5cudaHostAlloc(void **pHost, size_t size, unsigned int flags);
 ...
 */
extern  cudaError_t  gem5cudaHostGetDevicePointer(void **pDevice, void *pHost, unsigned int flags);
 ...
 * \sa ::cudaHostAlloc
 */
extern  cudaError_t  gem5cudaHostGetFlags(unsigned int *pFlags, void *pHost);
 ...
 * involving 2D or 3D objects (whether linear memory or gem5cuda arrays).
 *
 ...
 */
extern  cudaError_t  gem5cudaMalloc3D(struct cudaPitchedPtr* pitchedDevPtr, struct cudaExtent extent);
...
struct gem5cudaPos make_cudaPos(size_t x, size_t y, size_t z);

struct gem5cudaMemcpy3DParms {
  struct cudaArray     *srcArray;
  struct gem5cudaPos        srcPos;
  struct cudaPitchedPtr srcPtr;
  struct cudaArray     *dstArray;
  struct gem5cudaPos        dstPos;
 ...
 * destination objects may be in either host memory, device memory, or a gem5cuda
 ...
 * For gem5cuda arrays, positions must be in the range [0, 2048) for any
 * dimension.
 *
 * The \p extent field defines the dimensions of the transferred area in
 * elements. If a gem5cuda array is participating in the copy, the extent is
 * defined in terms of that array's elements. If no gem5cuda array is
 ...
 */
extern  cudaError_t  gem5cudaMemcpy3D(const struct gem5cudaMemcpy3DParms *p);
 ...
 * ::make_cudaExtent, ::make_cudaPos
 */
extern  cudaError_t  gem5cudaMemcpy3DAsync(const struct gem5cudaMemcpy3DParms *p, cudaStream_t stream __dv(0));
 ...
 *
 */
extern  cudaError_t  gem5cudaMemGetInfo(size_t *free, size_t *total);
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5cudaMemcpy(void *dst, const void *src, size_t count, enum cudaMemcpyKind kind);

/**
 * \brief Copies data between host and device
 *
 * Copies \p count bytes from the memory area pointed to by \p src to the
 * gem5cuda array \p dst starting at the upper left corner
 ...
 * \brief Copies data between host and device
 *
 * Copies \p count bytes from the gem5cuda array \p src starting at the upper
 ...
 *
 * Copies \p count bytes from the gem5cuda array \p src starting at the upper
 * left corner (\p wOffsetSrc, \p hOffsetSrc) to the gem5cuda array \p dst
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5cudaMemcpy2D(void *dst, size_t dpitch, const void *src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind);

/**
 * \brief Copies data between host and device
 *
 * Copies a matrix (\p height rows of \p width bytes each) from the memory
 * area pointed to by \p src to the gem5cuda array \p dst starting at the
 ...
 * \p width must not exceed the width of the gem5cuda array \p dst. \p width must
 ...
 * \brief Copies data between host and device
 *
 * Copies a matrix (\p height rows of \p width bytes each) from the gem5cuda
 ...
 * row. \p wOffset + \p width must not exceed the width of the gem5cuda array
 ...
 * Copies a matrix (\p height rows of \p width bytes each) from the gem5cuda
 * array \p srcArray starting at the upper left corner
 * (\p wOffsetSrc, \p hOffsetSrc) to the gem5cuda array \p dst starting at
 ...
 * of the gem5cuda array \p dst. \p wOffsetSrc + \p width must not exceed the width
 * of the gem5cuda array \p src.
 *
 * \param dst        - Destination memory address
 * \param wOffsetDst - Destination starting X offset
 * \param hOffsetDst - Destination starting Y offset
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5cudaMemcpyToSymbol(const char *symbol, const void *src, size_t count, size_t offset __dv(0), enum cudaMemcpyKind kind __dv(cudaMemcpyHostToDevice));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5cudaMemcpyFromSymbol(void *dst, const char *symbol, size_t count, size_t offset __dv(0), enum cudaMemcpyKind kind __dv(cudaMemcpyDeviceToHost));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5cudaMemcpyAsync(void *dst, const void *src, size_t count, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 * ::cudaMemcpyToSymbolAsync, ::cudaMemcpyFromSymbolAsync
 */
extern  cudaError_t  gem5cudaMemcpy2DAsync(void *dst, size_t dpitch, const void *src, size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5cudaMemcpyToSymbolAsync(const char *symbol, const void *src, size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5cudaMemcpyFromSymbolAsync(void *dst, const char *symbol, size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5cudaMemset(void *devPtr, int value, size_t count, cudaStream_t stream __dv(0));
 ...
 * ::cudaMemset2DAsync, ::cudaMemset3DAsync
 */
extern  cudaError_t  gem5cudaMemset2D(void *devPtr, size_t pitch, int value, size_t width, size_t height);
 ...
 * ::make_cudaExtent
 */
extern  cudaError_t  gem5cudaMemset3D(struct cudaPitchedPtr pitchedDevPtr, int value, struct cudaExtent extent);
 ...
 * ::cudaMemset2DAsync, ::cudaMemset3DAsync
 */
extern  cudaError_t  gem5cudaMemsetAsync(void *devPtr, int value, size_t count, cudaStream_t stream __dv(0));
 ...
 */
extern  cudaError_t  gem5cudaMemset2DAsync(void *devPtr, size_t pitch, int value, size_t width, size_t height, cudaStream_t stream __dv(0));
 ...
 * ::make_cudaExtent
 */
extern  cudaError_t  gem5cudaMemset3DAsync(struct cudaPitchedPtr pitchedDevPtr, int value, struct cudaExtent extent, cudaStream_t stream __dv(0));

/**
 * \brief Finds the address associated with a gem5cuda symbol
 *
 ...
 */
extern  cudaError_t  gem5cudaGetSymbolAddress(void **devPtr, const char *symbol);

/**
 * \brief Finds the size of the object associated with a gem5cuda symbol
 *
 ...
 */
extern  cudaError_t  gem5cudaGetSymbolSize(size_t *size, const char *symbol);

/** @} */ /* END gem5cudaRT_MEMORY */

/** \defgroup gem5cudaRT_OPENGL OpenGL Interoperability */

/** \defgroup gem5cudaRT_D3D9 Direct3D 9 Interoperability */

/** \defgroup gem5cudaRT_D3D10 Direct3D 10 Interoperability */

/** \defgroup gem5cudaRT_D3D11 Direct3D 11 Interoperability */

/** \defgroup gem5cudaRT_VDPAU VDPAU Interoperability */

/**
 * \defgroup gem5cudaRT_INTEROP Graphics Interoperability
 * This section describes the graphics interoperability functions of the gem5cuda
...
/**
 * \brief Unregisters a graphics resource for access by gem5cuda
 *
 * Unregisters the graphics resource \p resource so it is not accessible by
 * gem5cuda unless registered again.
 *
 ...
 */
extern  cudaError_t  gem5cudaGraphicsUnregisterResource(cudaGraphicsResource_t resource);
 ...
 *     be used. It is therefore assumed that gem5cuda may read from or write to \p resource.
 * - ::cudaGraphicsMapFlagsReadOnly: Specifies that gem5cuda will not write to \p resource.
 * - ::cudaGraphicsMapFlagsWriteDiscard: Specifies gem5cuda will not read from \p resource and will
 *   write over the entire contents of \p resource, so none of the data
 *   previously stored in \p resource will be preserved.
 *
 * If \p resource is presently mapped for access by gem5cuda then ::cudaErrorUnknown is returned.
 ...
 */
extern  cudaError_t  gem5cudaGraphicsResourceSetMapFlags(cudaGraphicsResource_t resource, unsigned int flags);

/**
 * \brief Map graphics resources for access by gem5cuda
 *
 * Maps the \p count graphics resources in \p resources for access by gem5cuda.
 *
 * The resources in \p resources may be accessed by gem5cuda until they
 * are unmapped. The graphics API from which \p resources were registered
 * should not access any resources while they are mapped by gem5cuda. If an
 * application does so, the results are undefined.
 *
 * This function provides the synchronization guarantee that any graphics calls
 * issued before ::cudaGraphicsMapResources() will complete before any subsequent gem5cuda
 ...
 * gem5cuda then ::cudaErrorUnknown is returned.
 *
 * \param count     - Number of resources to map
 * \param resources - Resources to map for gem5cuda
 ...
 */
extern  cudaError_t  gem5cudaGraphicsMapResources(int count, cudaGraphicsResource_t *resources, cudaStream_t stream __dv(0));
 ...
 *
 * Once unmapped, the resources in \p resources may not be accessed by gem5cuda
 * until they are mapped again.
 *
 * This function provides the synchronization guarantee that any gem5cuda work issued
 ...
 * ::cudaGraphicsMapResources
 */
extern  cudaError_t  gem5cudaGraphicsUnmapResources(int count, cudaGraphicsResource_t *resources, cudaStream_t stream __dv(0));
 ...
 * ::cudaGraphicsSubResourceGetMappedArray
 */
extern  cudaError_t  gem5cudaGraphicsResourceGetMappedPointer(void **devPtr, size_t *size, cudaGraphicsResource_t resource);
...
/**
 * \defgroup gem5cudaRT_TEXTURE Texture Reference Management
 * This section describes the low level texture reference management functions
 * of the gem5cuda runtime application programming interface.
 *
 * @{
 */
 ...
 *
 * Returns in \p *desc the channel descriptor of the gem5cuda array \p array.
 *
 ...
 * \notefnerr
 *
 * \sa \ref ::cudaCreateChannelDesc(int, int, int, int, gem5cudaChannelFormatKind) "cudaCreateChannelDesc (C API)",
 ...
 * \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
 */
extern  struct cudaChannelFormatDesc  gem5cudaCreateChannelDesc(int x, int y, int z, int w, enum cudaChannelFormatKind f);
 ...
 * \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
 */
extern  cudaError_t  gem5cudaBindTexture(size_t *offset, const struct textureReference *texref, const void *devPtr, const struct cudaChannelFormatDesc *desc, size_t size __dv(UINT_MAX));
 ...
 * \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
 */
extern  cudaError_t  gem5cudaBindTexture2D(size_t *offset, const struct textureReference *texref, const void *devPtr, const struct cudaChannelFormatDesc *desc, size_t width, size_t height, size_t pitch);

/**
 * \brief Binds an array to a texture
 *
 * Binds the gem5cuda array \p array to the texture reference \p texref.
 * \p desc describes how the memory is interpreted when fetching values from
 * the texture. Any gem5cuda array previously bound to \p texref is unbound.
 *
 * \param texref - Texture to bind
 * \param array  - Memory array on device
 * \param desc   - Channel format
 ...
 * \ref ::cudaGetTextureAlignmentOffset(size_t*, const struct textureReference*) "cudaGetTextureAlignmentOffset (C API)"
 */
extern  cudaError_t  gem5cudaUnbindTexture(const struct textureReference *texref);
 ...
 */
extern  cudaError_t  gem5cudaGetTextureAlignmentOffset(size_t *offset, const struct textureReference *texref);
 ...
 * \ref ::cudaUnbindTexture(const struct textureReference*) "cudaUnbindTexture (C API)"
 */
extern  cudaError_t  gem5cudaGetTextureReference(const struct textureReference **texref, const char *symbol);

/** @} */ /* END gem5cudaRT_TEXTURE */

/**
 * \defgroup gem5cudaRT_SURFACE Surface Reference Management
 ...
 *
 * Binds the gem5cuda array \p array to the surface reference \p surfref.
 * \p desc describes how the memory is interpreted when fetching values from
 * the surface. Any gem5cuda array previously bound to \p surfref is unbound.
 *
 ...
 */
extern  cudaError_t  gem5cudaGetSurfaceReference(const struct surfaceReference **surfref, const char *symbol);

/** @} */ /* END gem5cudaRT_SURFACE */

/**
 * \defgroup gem5cudaRT__VERSION Version Management
 *
 * @{
 */

/**
 * \brief Returns the gem5cuda driver version
 *
 * Returns in \p *driverVersion the version number of the installed gem5cuda
 ...
 *
 * \param driverVersion - Returns the gem5cuda driver version.
 *
 * \return
 * ::cudaSuccess,
 * ::cudaErrorInvalidValue
 ...
 */
extern  cudaError_t  gem5cudaDriverGetVersion(int *driverVersion);

/**
 * \brief Returns the gem5cuda Runtime version
 *
 * Returns in \p *runtimeVersion the version number of the installed gem5cuda
 * Runtime. This function automatically returns ::cudaErrorInvalidValue if
 * the \p runtimeVersion argument is NULL.
 *
 * \param runtimeVersion - Returns the gem5cuda Runtime version.
 *
 * \return
 * ::cudaSuccess,
 * ::cudaErrorInvalidValue
 ...
 */
extern  cudaError_t  gem5cudaRuntimeGetVersion(int *runtimeVersion);

/** @} */ /* END gem5cudaRT__VERSION */

/** \cond impl_private */
extern  cudaError_t  gem5cudaGetExportTable(const void **ppExportTable, const cudaUUID_t *pExportTableId);
/** \endcond impl_private */

/**
 * \defgroup gem5cudaRT_HIGHLEVEL C++ API Routines
 * This section describes the C++ high level API functions of the gem5cuda runtime
 * application programming interface. To use these functions, your
 * application needs to be compiled with the \p nvcc compiler.
 *
 * \brief C++-style interface built on top of gem5cuda runtime API
 */

/**
 * \defgroup gem5cudaRT_DRIVER Interactions with the gem5cuda Driver API
 * This section describes the interactions between the gem5cuda Driver API and the gem5cuda Runtime API
 *
 * \brief Interactions between the gem5cuda Driver API and the gem5cuda Runtime API.
 *
 * @{
 *
 * \section gem5cudaRT_CUDA_context Context Management
 *
 * gem5cuda Runtime API calls operate on the gem5cuda Driver API ::CUcontext which is bound to the current host thread.
 *
 * If there exists no gem5cuda Driver API ::CUcontext bound to the current thread at the time of a gem5cuda
 * Runtime API call which requires a ::CUcontext then the gem5cuda Runtime will implicitly create a new
 * ::CUcontext before executing the call.
 *
 * If the gem5cuda Runtime creates a ::CUcontext then the ::CUcontext will be created using the parameters
 * specified by the gem5cuda Runtime API functions
 * ::cudaSetDevice,
 * ::cudaSetValidDevices,
 * ::cudaSetDeviceFlags,
 * ::cudaGLSetGLDevice,
 ...
 *
 * If a ::CUcontext is created by the gem5cuda Runtime, then the gem5cuda runtime will decrement the
 * reference count of that ::CUcontext in the function ::cudaThreadExit.
 * If a ::CUcontext is created by the gem5cuda Driver API (or is created by a separate instance of the
 * gem5cuda Runtime API library), then the gem5cuda Runtime will not increment or decrement the reference
 * count of that ::CUcontext.
 *
 * All gem5cuda Runtime API state (e.g, global variables' addresses and values) travels
 * with its underlying ::CUcontext.
 * In particular, if a ::CUcontext is moved from one thread to another (using ::cuCtxPopCurrent and
 * ::cuCtxPushCurrent) then all gem5cuda Runtime API state will move to that thread as well.
 *
 * Please note that attaching to legacy contexts (those with a version of 3010 as returned
 * by ::cuCtxGetApiVersion()) is not possible. The gem5cuda Runtime will return
 * ::cudaErrorIncompatibleDriverContext in such cases.
 *
 * \section gem5cudaRT_CUDA_stream Interactions between CUstream and cudaStream_t
 *
 * The types ::CUstream and ::cudaStream_t are identical and may be used interchangeably.
 *
 * \section gem5cudaRT_CUDA_event Interactions between CUevent and cudaEvent_t
 *
 * The types ::CUevent and ::cudaEvent_t are identical and may be used interchangeably.
 *
 * \section gem5cudaRT_CUDA_array Interactions between CUarray and struct cudaArray *
 *
 ...
 *
 * In order to use a ::CUarray in a gem5cuda Runtime API function which takes a struct ::cudaArray *,
 * it is necessary to explicitly cast the ::CUarray to a struct ::cudaArray *.
 *
 * In order to use a struct ::cudaArray * in a gem5cuda Driver API function which takes a ::CUarray,
 * it is necessary to explicitly cast the struct ::cudaArray * to a ::CUarray .
 *
 * \section gem5cudaRT_CUDA_graphicsResource Interactions between CUgraphicsResource and cudaGraphicsResource_t
 *
 * The types ::CUgraphicsResource and struct ::cudaGraphicsResource * represent the same data type and may be used
 * interchangeably by casting the two types between each other.
 *
 * In order to use a ::CUgraphicsResource in a gem5cuda Runtime API function which takes a struct ::cudaGraphicsResource *,
 * it is necessary to explicitly cast the ::CUgraphicsResource to a struct ::cudaGraphicsResource *.
 *
 * In order to use a struct ::cudaGraphicsResource * in a gem5cuda Driver API function which takes a ::CUgraphicsResource,
 * it is necessary to explicitly cast the struct ::cudaGraphicsResource * to a ::CUgraphicsResource .
 *
 * @}
 */

// extern  cudaError_t  gem5cudaDeviceGetAttribute(int *value, enum cudaDeviceAttr attr, int device);
#if defined(__cplusplus)
}
#endif /* __cplusplus */
...
#endif /* !__GEM5CUDA_RUNTIME_API_H__ */
